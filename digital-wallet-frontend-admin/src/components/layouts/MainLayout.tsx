              ...
              <div className="mb-6 flex items-center gap-3 border-b border-border pb-6">
                ...
                {!collapsed ? (
                  <div className="flex flex-col gap-1">
                    <p className="text-sm font-semibold text-foreground">Digital Wallet Admin</p>
      ...
      >
        <DialogContent showCloseButton={false} className="max-w-sm rounded-2xl">
          <DialogHeader className="items-center text-center">
            <div className="mb-3 grid h-14 w-14 place-items-center rounded-full bg-[#BCF807]">
              <LogOut className="h-6 w-6 text-[#10110E]" />
            </div>
            <DialogTitle className="text-lg font-bold">Sign out?</DialogTitle>
            <DialogDescription className="text-sm text-muted-foreground">
              You will be signed out of Digital Wallet Admin. Any unsaved changes will be lost.
            </DialogDescription>
          </DialogHeader>
