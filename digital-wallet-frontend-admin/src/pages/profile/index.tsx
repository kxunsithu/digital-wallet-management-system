          ...
          <div className="space-y-4">
            <div className="overflow-hidden rounded-2xl border border-border bg-white">
              <div className="border-b border-border px-5 py-4">
                <div className="flex items-center gap-2">
                  <div className="grid h-8 w-8 place-items-center rounded-lg bg-[#BCF807] text-[#10110E]">
                ...
                <form className="space-y-5" onSubmit={handleSaveProfile}>
                  ...
                  <div className="flex justify-end">
                    <Button
                      type="submit"
                      disabled={saving}
                      className="h-10 rounded-lg bg-[#BCF807] font-semibold text-[#10110E] hover:bg-[#BCF807]/90"
                    >
                  ...
                  {(() => {
                    ...
                    const renderNrcImage = (image: ProfileImage | undefined, label: string) => {
                      ...
                      return (
                        <button
                          type="button"
                          className="group relative w-full cursor-pointer overflow-hidden rounded-xl border border-border bg-slate-50 transition-all hover:border-[#BCF807] hover:shadow-md focus:outline-none focus:ring-2 focus:ring-[#BCF807]/50 focus:ring-offset-2"
                ...
                <form className="space-y-5" onSubmit={handleChangePin}>
                  <div className="grid gap-4 md:grid-cols-3">
                    <div className="space-y-1.5">
                      ...
                      <Input
                        ...
                        placeholder="••••"
                        className="text-center tracking-widest focus-visible:ring-[#BCF807]/30"
                      />
                    </div>
                    <div className="space-y-1.5">
                  ...
                  <div className="flex justify-end">
                    <Button
                      ...
                      className="h-10 rounded-lg border-[#BCF807] font-semibold text-[#10110E] hover:bg-[#BCF807]/10"
                    >
