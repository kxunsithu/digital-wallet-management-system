        ...
        <div className="overflow-hidden rounded-2xl border border-border bg-white shadow-none">
          <div className="border-b border-border px-6 py-4">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2.5">
                <div className="grid h-9 w-9 place-items-center rounded-lg bg-[#BCF807] text-[#10110E]">
              ...
              <span className="rounded-full bg-[#BCF807] px-3 py-1 text-xs font-bold text-[#10110E]">
                Agent Manager Float
              </span>
            </div>
          </div>
          ...
          <div className="p-6 md:p-8">
            {loading ? (
              ...
              <div className="space-y-6">
                {/* Balance highlight */}
                <div className="flex flex-col items-center justify-center rounded-2xl border border-[#BCF807] bg-[#BCF807] p-8 text-center text-[#10110E]">
                ...
                <div className="grid gap-4 sm:grid-cols-2">
                  <div className="flex items-center gap-3 rounded-xl border border-border bg-slate-50/50 p-4">
                    <div className="grid h-10 w-10 shrink-0 place-items-center rounded-lg bg-[#10110E] text-[#BCF807]">
          ...
          <Card className="overflow-hidden rounded-2xl border border-border shadow-none">
            <CardHeader className="border-b border-border py-4">
              <CardTitle className="flex items-center gap-2.5 text-base font-semibold text-foreground">
                <div className="grid h-7 w-7 place-items-center rounded-md bg-[#BCF807] text-[#10110E]">
            ...
            <CardContent className="flex flex-col items-center gap-6 p-6 md:flex-row md:items-start">
              <div className="flex flex-col items-center shrink-0">
                ...
                <Badge className="mt-3 bg-[#BCF807] text-[#10110E] hover:bg-[#BCF807]">
                  Manager QR
                </Badge>
              </div>
              <div className="flex-1 space-y-4">
                ...
                <div className="flex items-center justify-between rounded-xl border border-border bg-white px-4 py-3">
                  ...
                  <Button
                    ...
                    variant="outline"
                    size="sm"
                    className="ml-3 h-8 shrink-0 border-border text-foreground hover:bg-[#BCF807]"
                    onClick={async () => {
                      try {
                ...
                <div className="grid grid-cols-2 gap-2 rounded-xl border border-border bg-slate-50/50 p-1.5">
                  <button
                    ...
                    className={`flex items-center justify-center gap-2 rounded-lg py-2.5 text-xs font-bold transition-all ${
                      recipientType === "agent"
                        ? "bg-[#BCF807] text-[#10110E] shadow-sm"
                  ...
                  <button
                    ...
                    className={`flex items-center justify-center gap-2 rounded-lg py-2.5 text-xs font-bold transition-all ${
                      recipientType === "admin"
                        ? "bg-[#10110E] text-[#BCF807] shadow-sm"
                        : "text-muted-foreground hover:text-foreground"
                    }`}
                    onClick={() => {
                ...
                <div className="space-y-4 rounded-xl border border-border bg-white p-5">
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      className="h-12 border-[#BCF807] font-mono focus-visible:ring-[#BCF807]/30"
                    />
                    <p className="text-xs text-muted-foreground">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex flex-col gap-2 sm:flex-row">
                      <Input
                        ...
                        className="h-12 border-[#BCF807] font-mono text-xs focus-visible:ring-[#BCF807]/30"
                      />
                      <div className="flex gap-2">
                        <Button
                          ...
                          className="h-12 whitespace-nowrap border-border hover:bg-[#BCF807]"
                        >
                          {lookupLoading ? (
                        ...
                        <Button
                          ...
                          className="h-12 bg-[#BCF807] font-semibold text-[#10110E] hover:bg-[#BCF807]/90"
                        >
                ...
                <div className="rounded-xl border border-border bg-white p-5">
                  {adminWalletLoading ? (
                    ...
                    <div className="flex items-start gap-4">
                      <div className="grid h-10 w-10 shrink-0 place-items-center rounded-full bg-[#10110E] text-[#BCF807]">
                      ...
                      <div className="min-w-0 flex-1">
                        ...
                        <Badge className="mt-2 bg-[#10110E] text-[#BCF807] hover:bg-[#10110E]">
                          Admin Recipient
                        </Badge>
                      </div>
                    </div>
                    ...
                    <div className="flex flex-col gap-2 sm:flex-row">
                      ...
                      <div className="flex gap-2">
                        <Button
                          ...
                          disabled={lookupLoading}
                          onClick={() => void resolveQrLookup(qrLookupValue)}
                          className="h-12 whitespace-nowrap border-border hover:bg-[#10110E] hover:text-[#BCF807]"
                        >
                          {lookupLoading ? (
                            <Loader2 className="mr-2 h-4 w-4 animate-spin" />
                          ) : null}
                        ...
                        <Button
                          ...
                          disabled={lookupLoading}
                          onClick={() => setScannerOpen(true)}
                          className="h-12 bg-[#10110E] font-semibold text-[#BCF807] hover:bg-[#10110E]/90"
                        >
                          <Camera className="mr-1.5 h-4 w-4" />
                          Scan
                        </Button>
              ...
              <div className="grid gap-4 md:grid-cols-2">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    className="h-12 border-[#BCF807] font-bold text-base focus-visible:ring-[#BCF807]/30"
                  />
                </div>
                <div className="space-y-2">
                  <Label
                  ...
                  <Input
                    ...
                    className="h-12 border-border focus-visible:ring-[#BCF807]/30"
                  />
                </div>
              </div>
              ...
              <div className="flex justify-end border-t border-border pt-4">
                <Button
                  ...
                  className={`h-12 rounded-xl px-8 font-bold ${
                    recipientType === "admin"
                      ? "bg-[#10110E] text-[#BCF807] hover:bg-[#10110E]/90"
                      : "bg-[#BCF807] text-[#10110E] hover:bg-[#BCF807]/90"
                  }`}
                >
                  {submitting ? (
                    <>
          ...
          <DialogHeader className="items-center text-center space-y-2">
            <div
              className={`mb-2 grid h-12 w-12 place-items-center rounded-full ${
                recipientType === "admin"
                  ? "bg-[#10110E] text-[#BCF807]"
                  : "bg-[#BCF807] text-[#10110E]"
              }`}
            >
