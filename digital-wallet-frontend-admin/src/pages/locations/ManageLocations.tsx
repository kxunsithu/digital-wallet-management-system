    ...
    <MainLayout title="Manage Locations">
      ...
      <div className="mb-6 flex flex-col gap-4 rounded-2xl border border-border bg-white p-5 sm:flex-row sm:items-center sm:justify-between md:p-6">
        ...
        <div className="flex items-center gap-2">
          <span className="rounded-full border border-[#BCF807] bg-white px-3 py-1.5 text-xs font-bold text-[#10110E]">
        ...
        <div className="overflow-hidden rounded-2xl border border-border bg-white">
          ...
          <div className="border-b border-border px-5 py-4">
            <div className="flex items-center justify-between">
              ...
              <span className="rounded-full bg-[#BCF807] px-2.5 py-1 text-xs font-bold text-[#10110E]">
                Geo Layer 1
              </span>
            </div>
          </div>
        ...
        <DialogContent showCloseButton={false}>
          <form onSubmit={handleEditRegionSubmit}>
            ...
            <DialogFooter>
              ...
              <Button type="submit" className="bg-[#BCF807] font-semibold text-[#10110E] hover:bg-[#BCF807]/90">Save Changes</Button>
            </DialogFooter>
          </form>
        </DialogContent>
      </Dialog>
