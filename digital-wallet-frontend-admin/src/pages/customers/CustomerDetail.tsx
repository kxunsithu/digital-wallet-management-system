          ...
          <div className="flex items-center gap-3">
            ...
            {hasNrcImages && (
              <Button
                ...
                className="h-9 rounded-lg border-border text-foreground hover:bg-[#BCF807] flex items-center gap-2"
              >
                  ...
                  {customer.user.nrc_verification.status === "pending" && (
                    <div className="flex flex-wrap gap-3 pt-2">
                      <Button
                        ...
                        disabled={actionLoading}
                        className="h-10 rounded-lg bg-[#BCF807] font-semibold text-[#10110E] hover:bg-[#BCF807]"
                      >
                        Approve NRC
                      </Button>
                      <Button
            ...
            {selectedKycStatus === "rejected" && (
              <div className="space-y-2">
                ...
                <Textarea
                  ...
                  className="w-full min-h-[100px] rounded-xl border border-border bg-white px-3 py-2 text-sm focus-visible:ring-[#BCF807]"
                />
              </div>
            )}
          </div>
