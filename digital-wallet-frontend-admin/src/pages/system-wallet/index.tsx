...
const SystemWalletPage = () => {
  ...
  const statusColor = (status?: string) => {
    switch (status) {
      case "active":
        return "border-[#BDF40B] bg-[#BDF40B] text-[#10110E]";
      case "frozen":
    ...
    <MainLayout title="System Wallet">
      <div className="mx-auto max-w-7xl space-y-6">
        <div className="overflow-hidden rounded-2xl border border-border bg-card">
          <div className="border-b border-border bg-[#BDF40B] px-6 py-3 text-xs font-bold tracking-[0.2em] text-[#10110E] uppercase md:px-8">
            System treasury
          </div>
            ...
            {loading ? (
              ...
              <>
                <div className="mb-6 flex items-center gap-3">
                  <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-[#BDF40B] text-[#10110E]">
                ...
                <div className="mb-8">
                  <div className="mb-1 flex items-center gap-3">
                    ...
                    <button
                      ...
                      className="ml-auto flex h-7 w-7 items-center justify-center rounded-lg border border-border bg-white text-muted-foreground transition-colors hover:border-[#BDF40B] hover:text-[#10110E]"
                    >
                ...
                <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
                  <div className="group flex items-start gap-3 rounded-xl border border-border bg-white p-4 transition-colors hover:border-[#BDF40B]">
                    <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg bg-[#BDF40B] text-[#10110E]">
        ...
        <Card className="overflow-hidden rounded-2xl border border-border shadow-none xl:sticky xl:top-24">
          <CardHeader className="border-b border-border px-6 py-5">
            <CardTitle className="flex items-center gap-2.5 text-lg font-semibold text-foreground">
              <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-[#BDF40B] text-[#10110E]">
            ...
            {loading ? (
              ...
              <div className="flex flex-col items-center gap-6">
                <div className="group relative flex-shrink-0">
                  <div className="rounded-2xl border border-border bg-white p-5 shadow-sm transition-shadow group-hover:border-[#BDF40B]">
                ...
                <div className="flex-1 space-y-4">
                  <div className="rounded-xl border border-border bg-white p-4">
                    <p className="text-sm leading-relaxed text-slate-600">
                      ...
                      using the{" "}
                      <span className="inline-flex items-center gap-1 rounded-md bg-[#BDF40B] px-2 py-0.5 text-xs font-medium text-[#10110E]">
            ...
            <form className="space-y-6" onSubmit={handleTransferClick}>
              ...
              <div className="flex justify-end">
                <Button
                  type="submit"
                  disabled={submitting}
                  className="h-12 w-full gap-2 rounded-xl bg-[#BDF40B] text-sm font-semibold tracking-wide text-[#10110E] shadow-none transition-all hover:bg-[#BDF40B] disabled:opacity-60 md:w-auto md:px-8"
                >
                  {submitting ? (
                    <>
