...
const SystemWalletPage = () => {
  ...
  const statusColor = (status?: string) => {
    switch (status) {
      case "active":
        return "border-[#BCF807] bg-[#BCF807] text-[#10110E]";
      case "frozen":
            ...
            {loading ? (
              ...
              <>
                <div className="mb-6 flex items-center gap-3">
                  <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-[#BCF807] text-[#10110E]">
                ...
                <div className="mb-8">
                  <div className="mb-1 flex items-center gap-3">
                    ...
                    <button
                      ...
                      className="ml-auto flex h-7 w-7 items-center justify-center rounded-lg border border-border bg-white text-muted-foreground transition-colors hover:border-[#BCF807] hover:text-[#10110E]"
                    >
                ...
                <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
                  <div className="group flex items-start gap-3 rounded-xl border border-border bg-white p-4 transition-colors hover:border-[#BCF807]">
                    <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg bg-[#BCF807] text-[#10110E]">
            ...
            {loading ? (
              ...
              <div className="flex flex-col items-center gap-6">
                <div className="group relative flex-shrink-0">
                  <div className="rounded-2xl border border-border bg-white p-5 shadow-sm transition-shadow group-hover:border-[#BCF807]">
                ...
                <div className="flex-1 space-y-4">
                  <div className="rounded-xl border border-border bg-white p-4">
                    <p className="text-sm leading-relaxed text-slate-600">
                      ...
                      using the{" "}
                      <span className="inline-flex items-center gap-1 rounded-md bg-[#BCF807] px-2 py-0.5 text-xs font-medium text-[#10110E]">
            ...
            <form className="space-y-6" onSubmit={handleTransferClick}>
              ...
              <div className="flex justify-end">
                <Button
                  type="submit"
                  disabled={submitting}
                  className="h-12 w-full gap-2 rounded-xl bg-[#BCF807] text-sm font-semibold tracking-wide text-[#10110E] shadow-none transition-all hover:bg-[#BCF807] disabled:opacity-60 md:w-auto md:px-8"
                >
                  {submitting ? (
                    <>
