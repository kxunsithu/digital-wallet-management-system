        ...
        <div className="space-y-6">
          ...
          <div className="flex flex-col gap-4 rounded-2xl border border-border bg-white p-5 sm:flex-row sm:items-center sm:justify-between md:p-6">
            ...
            <div className="flex items-center gap-2">
              <span className="rounded-full border border-[#BDF40B] bg-[#BDF40B] px-3 py-1.5 text-xs font-bold text-[#10110E]">
                Manager Workspace
              </span>
          ...
          <div className="grid gap-6 xl:grid-cols-[1.35fr_0.95fr]">
            ...
            <div className="space-y-6">
                    ...
                    <div className="space-y-6">
                      ...
                      <div className="grid gap-4 sm:grid-cols-2">
                        <div className="flex items-start gap-3 rounded-xl border border-border bg-slate-50/50 p-4">
                          <div className="grid h-9 w-9 shrink-0 place-items-center rounded-lg bg-[#10110E] text-[#BDF40B]">
                      ...
                      <div className="flex flex-wrap gap-3 pt-2">
                        <Button
                          ...
                          className="h-11 bg-[#BDF40B] font-semibold text-[#10110E] hover:bg-[#BDF40B]/90 shadow-none border-0"
                        >
                          Transfer to Agent
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                <Card className="border-border bg-white shadow-none hover:border-[#BDF40B]/50 transition-all">
                  <CardContent className="p-5 flex items-center justify-between">
                    ...
                    <div className="grid h-12 w-12 place-items-center rounded-xl bg-[#BDF40B]/10 text-[#10110E]">
