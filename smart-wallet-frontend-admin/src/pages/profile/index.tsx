          ...
          <div className="space-y-4">
            <div className="overflow-hidden rounded-2xl border border-border bg-white">
              <div className="border-b border-border px-5 py-4">
                <div className="flex items-center gap-2">
                  <div className="grid h-8 w-8 place-items-center rounded-lg bg-[#BDF40B] text-[#10110E]">
                  ...
                  <div className="grid gap-4 md:grid-cols-2">
                    ...
                    <div className="space-y-1.5">
                      ...
                      <Input
                        ...
                        className="focus-visible:ring-[#BDF40B]/30"
                      />
                    </div>
                    <div className="space-y-1.5 md:col-span-2">
                      ...
                      <Input
                        ...
                        className="focus-visible:ring-[#BDF40B]/30 disabled:bg-slate-50 disabled:text-slate-500 disabled:cursor-not-allowed"
                      />
                    </div>
                  </div>
                  ...
                  {(() => {
                    ...
                    const renderNrcImage = (image: ProfileImage | undefined, label: string) => {
                      ...
                      return (
                        <button
                          type="button"
                          className="group relative w-full cursor-pointer overflow-hidden rounded-xl border border-border bg-slate-50 transition-all hover:border-[#BDF40B] hover:shadow-md focus:outline-none focus:ring-2 focus:ring-[#BDF40B]/50 focus:ring-offset-2"
                ...
                <form className="space-y-5" onSubmit={handleChangePin}>
                  <div className="grid gap-4 md:grid-cols-3">
                    <div className="space-y-1.5">
                      ...
                      <Input
                        ...
                        placeholder="••••"
                        className="text-center tracking-widest focus-visible:ring-[#BDF40B]/30"
                      />
                    </div>
                    <div className="space-y-1.5">
                  ...
                  <div className="flex justify-end">
                    <Button
                      ...
                      className="h-10 rounded-lg border-[#BDF40B] font-semibold text-[#10110E] hover:bg-[#BDF40B]/10"
                    >
