              ...
              <div className="space-y-2">
                ...
                <div className="grid grid-cols-2 gap-2 rounded-xl border border-border bg-slate-50/50 p-1.5">
                  ...
                  <button
                    ...
                    className={`flex items-center justify-center gap-2 rounded-lg py-2.5 text-xs font-bold transition-all ${
                      recipientType === "admin"
                        ? "bg-[#10110E] text-[#D5E726] shadow-sm"
                        : "text-muted-foreground hover:text-foreground"
                    }`}
                    onClick={() => {
                ...
                <div className="rounded-xl border border-border bg-white p-5">
                  {adminWalletLoading ? (
                    ...
                    <div className="flex items-start gap-4">
                      <div className="grid h-10 w-10 shrink-0 place-items-center rounded-full bg-[#10110E] text-[#D5E726]">
                      ...
                      <div className="min-w-0 flex-1">
                        ...
                        <Badge className="mt-2 bg-[#10110E] text-[#D5E726] hover:bg-[#10110E]">
                          Admin Recipient
                        </Badge>
                      </div>
                    </div>
                    ...
                    <div className="flex flex-col gap-2 sm:flex-row">
                      ...
                      <div className="flex gap-2">
                        <Button
                          ...
                          disabled={lookupLoading}
                          onClick={() => void resolveQrLookup(qrLookupValue)}
                          className="h-12 whitespace-nowrap border-border hover:bg-[#10110E] hover:text-[#D5E726]"
                        >
                          {lookupLoading ? (
                            <Loader2 className="mr-2 h-4 w-4 animate-spin" />
                          ) : null}
                        ...
                        <Button
                          ...
                          disabled={lookupLoading}
                          onClick={() => setScannerOpen(true)}
                          className="h-12 bg-[#10110E] font-semibold text-[#D5E726] hover:bg-[#10110E]/90"
                        >
                          <Camera className="mr-1.5 h-4 w-4" />
                          Scan
                        </Button>
              ...
              <div className="flex justify-end border-t border-border pt-4">
                <Button
                  ...
                  className={`h-12 rounded-xl px-8 font-bold ${
                    recipientType === "admin"
                      ? "bg-[#10110E] text-[#D5E726] hover:bg-[#10110E]/90"
                      : "bg-[#D5E726] text-[#10110E] hover:bg-[#D5E726]/90"
                  }`}
                >
                  {submitting ? (
                    <>
          ...
          <DialogHeader className="items-center text-center space-y-2">
            <div
              className={`mb-2 grid h-12 w-12 place-items-center rounded-full ${
                recipientType === "admin"
                  ? "bg-[#10110E] text-[#D5E726]"
                  : "bg-[#D5E726] text-[#10110E]"
              }`}
            >
